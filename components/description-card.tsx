        ...
        <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
            <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
                <Container className="h-8 w-8 circle-1">
                    <Image src="https://assets.subito.it/static/logos/corporate-short.svg" alt="idealista" className="h-32 w-32 " width={20} height={20}/>
                </Container>
                <Container className="h-12 w-12 circle-2">
                    <Image src="casa-it-seeklogo.svg" alt="casa" className="h-32 w-32 " width={20} height={20} />                    
                </Container>
                <Container className="circle-3">
                    <Image src="/immobiliare-logo.png" alt="immobiliare" className="h-6 w-8 " width={16} height={16} />
                    
                </Container>
                <Container className="h-12 w-12 circle-4">
                    <Image src="https://st3.idealista.it/static/common/img/idealista.svg" alt="idealista" className="h-32 w-32 " width={20} height={20} />
                </Container>
