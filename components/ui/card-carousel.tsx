    ...
    return (
        ...
        >
            <div className="relative w-full">
                <div
                    className="flex w-full overflow-x-scroll overscroll-x-auto py-4 md:pb-8 md:pt-4 scroll-smooth [scrollbar-width:none]"
                    ref={carouselRef}
                ...
                >
                    ...
                    <div
                        className={cn(
                            ...
                            "mx-auto max-w-xl md:max-w-screen-2xl" // remove max-w-4xl if you want the carousel to span the full width of its container
                        )}
                    >
